...
Battle Cinematics is renderer-independent by design. It attaches to compatible live battle-camera / presentation seams instead of replacing another mod's renderer or model set.
...
- This is a loader/index compatibility hotfix only; supported-backend camera behaviour remains unchanged from v1.0.9.
...
- Hardened Gen 1 manual right-stick takeover against stale transition input / unintended continuous orbit.
- Reorganised the options menu around Idle Preset and Pokémon Intro camera systems.
- Preserved all established v1.0.8 Gen 1 + Gold backend/provider compatibility.
